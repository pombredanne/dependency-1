 ...
 * apidoc:0.11.1 http://www.apidoc.me/flow/github-oauth/0.0.1-dev/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectAccessTokenForm(obj: io.flow.github.oauth.v0.models.AccessTokenForm) = {
      play.api.libs.json.Json.obj(
        ...
        "redirect_uri" -> play.api.libs.json.Json.toJson(obj.redirectUri),
        "state" -> play.api.libs.json.Json.toJson(obj.state)
      )
    }
...
package io.flow.github.oauth.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.1 http://www.apidoc.me/flow/github-oauth/0.0.1-dev/play_2_4_client"
