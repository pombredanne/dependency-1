 ...
 * Service version: 0.0.26
 * apidoc:0.11.27 http://www.apidoc.me/flow/common/0.0.26/anorm_2_x_parsers
 */
package io.flow.common.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqCommonDimensionType: Column[Seq[_root_.io.flow.common.v0.models.DimensionType]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.DimensionType]] }
    implicit val columnToMapCommonDimensionType: Column[Map[String, _root_.io.flow.common.v0.models.DimensionType]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.DimensionType]] }
