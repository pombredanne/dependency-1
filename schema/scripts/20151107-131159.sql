-- File created automatically by https://github.com/flowcommerce/lib-postgresql/blob/master/schema/install


-- Start of file https://github.com/flowcommerce/lib-postgresql/blob/master/schema/audit.sql
create schema audit;
...
-- Start of file https://github.com/flowcommerce/lib-postgresql/blob/master/schema/journal-1.sql
create schema journal;
set search_path to journal;

-- Start of file https://github.com/flowcommerce/lib-postgresql/blob/master/schema/journal-2.sql
...
-- Start of file https://github.com/flowcommerce/lib-postgresql/blob/master/schema/util.sql
create schema util;
