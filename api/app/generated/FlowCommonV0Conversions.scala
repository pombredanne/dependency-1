 ...
 * apidoc:0.10.1 http://localhost:9000/flow/common/0.0.5-dev/anorm_2_x_parsers
 */
package io.flow.common.v0.anorm.conversions {
  ...
  object Json {
    ...
    implicit val columnToExpandableOrganization: Column[io.flow.common.v0.models.ExpandableOrganization] = parser { _.as[io.flow.common.v0.models.ExpandableOrganization] }
    implicit val columnToExpandableUser: Column[io.flow.common.v0.models.ExpandableUser] = parser { _.as[io.flow.common.v0.models.ExpandableUser] }
