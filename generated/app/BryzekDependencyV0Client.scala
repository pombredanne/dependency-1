...
package com.bryzek.dependency.v0.models {
   ...
   * to the union Recommendation, it will need to be handled in the client code. This
   * implementation will deserialize these future types as an instance of this class.
   */
  case class RecommendationUndefinedType(
    description: String
  ) extends Recommendation
...
package com.bryzek.dependency.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDependencyRecommendation: play.api.libs.json.Reads[Recommendation] = {
      (
        (__ \ "library_recommendation").read(jsonReadsDependencyLibraryRecommendation).asInstanceOf[play.api.libs.json.Reads[Recommendation]]
        orElse
        (__ \ "binary_recommendation").read(jsonReadsDependencyBinaryRecommendation).asInstanceOf[play.api.libs.json.Reads[Recommendation]]
        orElse
        play.api.libs.json.Reads(jsValue => play.api.libs.json.JsSuccess(com.bryzek.dependency.v0.models.RecommendationUndefinedType(jsValue.toString))).asInstanceOf[play.api.libs.json.Reads[Recommendation]]
      )
    }

    implicit def jsonWritesDependencyRecommendation: play.api.libs.json.Writes[Recommendation] = new play.api.libs.json.Writes[Recommendation] {
      def writes(obj: Recommendation) = obj match {
        case x: com.bryzek.dependency.v0.models.LibraryRecommendation => play.api.libs.json.Json.obj("library_recommendation" -> jsonWritesDependencyLibraryRecommendation.writes(x))
        case x: com.bryzek.dependency.v0.models.BinaryRecommendation => play.api.libs.json.Json.obj("binary_recommendation" -> jsonWritesDependencyBinaryRecommendation.writes(x))
        case x: com.bryzek.dependency.v0.models.RecommendationUndefinedType => sys.error(s"The type[com.bryzek.dependency.v0.models.RecommendationUndefinedType] should never be serialized")
      }
    }
  }
}
