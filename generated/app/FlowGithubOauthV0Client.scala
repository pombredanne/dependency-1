 ...
 * apidoc:0.9.48 http://www.apidoc.me/flow/github-oauth/0.0.1-dev/play_2_4_client
 */
...
package io.flow.github.oauth.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsGithubOauthTokenType = __.read[String].map(TokenType.apply)
    implicit val jsonWritesGithubOauthTokenType = new Writes[TokenType] {
      def writes(x: TokenType) = JsString(x.toString)
    }
    ...
    implicit def jsonWritesGithubOauthAccessToken: play.api.libs.json.Writes[AccessToken] = {
      (
        ...
        (__ \ "scope").write[String] and
        (__ \ "token_type").write[io.flow.github.oauth.v0.models.TokenType]
      )(unlift(AccessToken.unapply _))
    }
    ...
    implicit def jsonWritesGithubOauthAccessTokenForm: play.api.libs.json.Writes[AccessTokenForm] = {
      (
        ...
        (__ \ "client_secret").write[String] and
        (__ \ "code").write[String] and
        (__ \ "redirect_uri").writeNullable[String] and
        (__ \ "state").writeNullable[String]
      )(unlift(AccessTokenForm.unapply _))
    }
  }
}
...
package io.flow.github.oauth.v0 {
  ...
  object Bindables {
    ...
    // Enum: TokenType
    private[this] val enumTokenTypeNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${io.flow.github.oauth.v0.models.TokenType.all.mkString(", ")}"
...
package io.flow.github.oauth.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.48 http://www.apidoc.me/flow/github-oauth/0.0.1-dev/play_2_4_client"
  ...
  class Client(
    ...
    logger.info(s"Initializing io.flow.github.oauth.v0.Client for url $apiUrl")

    def accessTokens: AccessTokens = AccessTokens

    object AccessTokens extends AccessTokens {
      override def postLoginAndOauthAndAccessToken(
        ...
        _executeRequest("POST", s"/login/oauth/access_token", body = Some(payload)).map {
  ...
  trait AccessTokens {
    def postLoginAndOauthAndAccessToken(
      accessTokenForm: io.flow.github.oauth.v0.models.AccessTokenForm
    )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.github.oauth.v0.models.AccessToken]
  }
