 ...
 * apidoc:0.11.4 http://localhost:9000/flow/github-oauth/0.0.3/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectAccessTokenForm(obj: io.flow.github.oauth.v0.models.AccessTokenForm) = {
      play.api.libs.json.Json.obj(
        ...
        case Some(x) => play.api.libs.json.Json.obj("redirect_uri" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.state match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("state" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
package io.flow.github.oauth.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.4 http://localhost:9000/flow/github-oauth/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
