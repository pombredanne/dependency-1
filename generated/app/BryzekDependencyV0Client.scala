 ...
 * apidoc:0.10.0 http://localhost:9000/bryzek/dependency/0.0.11/play_2_4_client
 */
...
package com.bryzek.dependency.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesDependencyCredentials: play.api.libs.json.Writes[Credentials] = new play.api.libs.json.Writes[Credentials] {
      def writes(obj: com.bryzek.dependency.v0.models.Credentials) = obj match {
    ...
    implicit def jsonWritesDependencyItemSummary: play.api.libs.json.Writes[ItemSummary] = new play.api.libs.json.Writes[ItemSummary] {
      def writes(obj: com.bryzek.dependency.v0.models.ItemSummary) = obj match {
...
package com.bryzek.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.0 http://localhost:9000/bryzek/dependency/0.0.11/play_2_4_client"
    val Version = "0.0.11"
    val VersionMajor = 0
