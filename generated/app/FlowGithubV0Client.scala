 ...
 * apidoc:0.11.3 http://localhost:9000/flow/github/0.0.3/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectHookConfig(obj: io.flow.github.v0.models.HookConfig) = {
      play.api.libs.json.Json.obj(
        ...
        "content_type" -> play.api.libs.json.Json.toJson(obj.contentType)
      )
    }
    ...
    def jsObjectUser(obj: io.flow.github.v0.models.User) = {
      play.api.libs.json.Json.obj(
        ...
        "avatar_url" -> play.api.libs.json.Json.toJson(obj.avatarUrl),
        "gravatar_id" -> play.api.libs.json.Json.toJson(obj.gravatarId),
        "url" -> play.api.libs.json.JsString(obj.url),
        "html_url" -> play.api.libs.json.JsString(obj.htmlUrl),
        "type" -> play.api.libs.json.JsString(obj.`type`.toString)
      )
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.3 http://localhost:9000/flow/github/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
