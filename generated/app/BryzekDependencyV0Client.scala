 ...
 * Service version: 0.0.21
 * apidoc:0.11.4 http://localhost:9000/bryzek/dependency/0.0.21/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectLibraryForm(obj: com.bryzek.dependency.v0.models.LibraryForm) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("version" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectLibraryVersion(obj: com.bryzek.dependency.v0.models.LibraryVersion) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("cross_build_version" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectProjectBinary(obj: com.bryzek.dependency.v0.models.ProjectBinary) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("binary" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectProjectLibrary(obj: com.bryzek.dependency.v0.models.ProjectLibrary) = {
      ...
      (obj.library match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("library" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectProjectPatchForm(obj: com.bryzek.dependency.v0.models.ProjectPatchForm) = {
      ...
      (obj.scms match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("scms" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.uri match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("uri" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectResolver(obj: com.bryzek.dependency.v0.models.Resolver) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("organization" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.credentials match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("credentials" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectToken(obj: com.bryzek.dependency.v0.models.Token) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("cleartext" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.description match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("description" -> play.api.libs.json.Json.toJson(x))
    ...
    def jsObjectUsernamePassword(obj: com.bryzek.dependency.v0.models.UsernamePassword) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("password" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
package com.bryzek.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.4 http://localhost:9000/bryzek/dependency/0.0.21/play_2_4_client"
    val Version = "0.0.21"
    val VersionMajor = 0
