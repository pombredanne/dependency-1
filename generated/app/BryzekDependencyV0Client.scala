 ...
 * apidoc:0.11.3 http://www.apidoc.me/bryzek/dependency/0.0.17/play_2_4_client
 */
package com.bryzek.dependency.v0.models {
  ...
  case class GithubRepository(
    id: Long,
    fullName: String,
    owner: com.bryzek.dependency.v0.models.GithubAccount
  )
  ...
  /**
   * Documents the payload of the data coming from github in webhooks
   */
  case class GithubWebhookBody(
    hookId: Long,
    hook: com.bryzek.dependency.v0.models.GithubHook,
    repository: com.bryzek.dependency.v0.models.GithubRepository,
    sender: com.bryzek.dependency.v0.models.GithubAccount
  )
...
package com.bryzek.dependency.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDependencyGithubAccount: play.api.libs.json.Reads[GithubAccount] = {
      (
        (__ \ "id").read[Long] and
        (__ \ "login").read[String]
      )(GithubAccount.apply _)
    }

    def jsObjectGithubAccount(obj: com.bryzek.dependency.v0.models.GithubAccount) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesDependencyGithubAccount: play.api.libs.json.Writes[GithubAccount] = {
      new play.api.libs.json.Writes[com.bryzek.dependency.v0.models.GithubAccount] {
        def writes(obj: com.bryzek.dependency.v0.models.GithubAccount) = {
          jsObjectGithubAccount(obj)
        }
      }
    }
    ...
    implicit def jsonReadsDependencyGithubHook: play.api.libs.json.Reads[GithubHook] = {
      (
        (__ \ "id").read[Long] and
        (__ \ "name").read[String] and
        (__ \ "events").read[Seq[String]]
      )(GithubHook.apply _)
    }

    def jsObjectGithubHook(obj: com.bryzek.dependency.v0.models.GithubHook) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsNumber(obj.id),
    ...
    implicit def jsonWritesDependencyGithubHook: play.api.libs.json.Writes[GithubHook] = {
      new play.api.libs.json.Writes[com.bryzek.dependency.v0.models.GithubHook] {
        def writes(obj: com.bryzek.dependency.v0.models.GithubHook) = {
          jsObjectGithubHook(obj)
        }
      }
    }

    implicit def jsonReadsDependencyGithubRepository: play.api.libs.json.Reads[GithubRepository] = {
      (
        (__ \ "id").read[Long] and
        (__ \ "full_name").read[String] and
        (__ \ "owner").read[com.bryzek.dependency.v0.models.GithubAccount]
      )(GithubRepository.apply _)
    }

    def jsObjectGithubRepository(obj: com.bryzek.dependency.v0.models.GithubRepository) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsNumber(obj.id),
        "full_name" -> play.api.libs.json.JsString(obj.fullName),
        "owner" -> jsObjectGithubAccount(obj.owner)
      )
    }

    implicit def jsonWritesDependencyGithubRepository: play.api.libs.json.Writes[GithubRepository] = {
      new play.api.libs.json.Writes[com.bryzek.dependency.v0.models.GithubRepository] {
        def writes(obj: com.bryzek.dependency.v0.models.GithubRepository) = {
          jsObjectGithubRepository(obj)
        }
      }
    }
    ...
    implicit def jsonReadsDependencyGithubWebhookBody: play.api.libs.json.Reads[GithubWebhookBody] = {
      (
        (__ \ "hook_id").read[Long] and
        (__ \ "hook").read[com.bryzek.dependency.v0.models.GithubHook] and
        (__ \ "repository").read[com.bryzek.dependency.v0.models.GithubRepository] and
        (__ \ "sender").read[com.bryzek.dependency.v0.models.GithubAccount]
      )(GithubWebhookBody.apply _)
    }

    def jsObjectGithubWebhookBody(obj: com.bryzek.dependency.v0.models.GithubWebhookBody) = {
      play.api.libs.json.Json.obj(
        "hook_id" -> play.api.libs.json.JsNumber(obj.hookId),
        "hook" -> jsObjectGithubHook(obj.hook),
        "repository" -> jsObjectGithubRepository(obj.repository),
        "sender" -> jsObjectGithubAccount(obj.sender)
      )
    }

    implicit def jsonWritesDependencyGithubWebhookBody: play.api.libs.json.Writes[GithubWebhookBody] = {
      new play.api.libs.json.Writes[com.bryzek.dependency.v0.models.GithubWebhookBody] {
        def writes(obj: com.bryzek.dependency.v0.models.GithubWebhookBody) = {
          jsObjectGithubWebhookBody(obj)
        }
      }
    }
...
package com.bryzek.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.3 http://www.apidoc.me/bryzek/dependency/0.0.17/play_2_4_client"
    val Version = "0.0.17"
    val VersionMajor = 0
