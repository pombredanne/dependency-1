 ...
 * apidoc:0.10.0 http://www.apidoc.me/bryzek/dependency/0.0.12/play_2_4_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesDependencyUserForm: play.api.libs.json.Writes[UserForm] = {
      (
        ...
        (__ \ "name").writeNullable[io.flow.common.v0.models.Name]
    ...
    implicit def jsonWritesDependencyCredentials: play.api.libs.json.Writes[Credentials] = new play.api.libs.json.Writes[Credentials] {
      def writes(obj: com.bryzek.dependency.v0.models.Credentials) = {
        obj match {
          case x: com.bryzek.dependency.v0.models.UsernamePassword => play.api.libs.json.Json.obj(
            "discriminator" -> "username_password",
            "username" -> play.api.libs.json.Json.toJson(x.username),
            "password" -> play.api.libs.json.Json.toJson(x.password)
          )
          case x: com.bryzek.dependency.v0.models.CredentialsUndefinedType => {
            sys.error("The type[com.bryzek.dependency.v0.models.CredentialsUndefinedType] should never be serialized")
          }
        }
      }
    }
    ...
    implicit def jsonWritesDependencyItemSummary: play.api.libs.json.Writes[ItemSummary] = new play.api.libs.json.Writes[ItemSummary] {
      def writes(obj: com.bryzek.dependency.v0.models.ItemSummary) = {
        obj match {
          case x: com.bryzek.dependency.v0.models.BinarySummary => play.api.libs.json.Json.obj(
            "discriminator" -> "binary_summary",
            "id" -> play.api.libs.json.Json.toJson(x.id),
            "organization" -> play.api.libs.json.Json.toJson(x.organization),
            "name" -> play.api.libs.json.Json.toJson(x.name)
          )
          case x: com.bryzek.dependency.v0.models.LibrarySummary => play.api.libs.json.Json.obj(
            "discriminator" -> "library_summary",
            "id" -> play.api.libs.json.Json.toJson(x.id),
            "organization" -> play.api.libs.json.Json.toJson(x.organization),
            "group_id" -> play.api.libs.json.Json.toJson(x.groupId),
            "artifact_id" -> play.api.libs.json.Json.toJson(x.artifactId)
          )
          case x: com.bryzek.dependency.v0.models.ProjectSummary => play.api.libs.json.Json.obj(
            "discriminator" -> "project_summary",
            "id" -> play.api.libs.json.Json.toJson(x.id),
            "organization" -> play.api.libs.json.Json.toJson(x.organization),
            "name" -> play.api.libs.json.Json.toJson(x.name)
          )
          case x: com.bryzek.dependency.v0.models.ItemSummaryUndefinedType => {
            sys.error("The type[com.bryzek.dependency.v0.models.ItemSummaryUndefinedType] should never be serialized")
          }
        }
      }
    }
...
package com.bryzek.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.0 http://www.apidoc.me/bryzek/dependency/0.0.12/play_2_4_client"
    val Version = "0.0.12"
    val VersionMajor = 0
