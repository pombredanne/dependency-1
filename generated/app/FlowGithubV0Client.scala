 ...
 * apidoc:0.11.4 http://localhost:9000/flow/github/0.0.3/play_2_4_client
 */
...
package io.flow.github.v0.models {
  ...
  package object json {
    ...
    def jsObjectHookConfig(obj: io.flow.github.v0.models.HookConfig) = {
      (obj.url match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("url" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.contentType match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("content_type" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectUser(obj: io.flow.github.v0.models.User) = {
      ...
      (obj.gravatarId match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("gravatar_id" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.4 http://localhost:9000/flow/github/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
