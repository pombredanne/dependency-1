 ...
 * apidoc:0.11.19 http://www.apidoc.me/bryzek/dependency/0.3.16/play_2_4_client
 */
...
package com.bryzek.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.19 http://www.apidoc.me/bryzek/dependency/0.3.16/play_2_4_client"
    val Version = "0.3.16"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Syncs extends Syncs {
      ...
      override def postBinariesById(
        ...
        _executeRequest("POST", s"/syncs/binaries/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}").map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw new com.bryzek.dependency.v0.errors.UnitResponse(r.status)
      ...
      override def postLibrariesById(
        ...
        _executeRequest("POST", s"/syncs/libraries/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}").map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw new com.bryzek.dependency.v0.errors.UnitResponse(r.status)
          case r => throw new com.bryzek.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 404")
        }
      ...
      override def postProjectsById(
        ...
        _executeRequest("POST", s"/syncs/projects/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}").map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw new com.bryzek.dependency.v0.errors.UnitResponse(r.status)
          case r => throw new com.bryzek.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 404")
        }
