 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/common/0.1.55/play_2_x_json
 */
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    def jsObjectLineItem(obj: io.flow.common.v0.models.LineItem) = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectMoney(obj: io.flow.common.v0.models.Money) = {
      play.api.libs.json.Json.obj(
    ...
    def jsObjectPriceWithBase(obj: io.flow.common.v0.models.PriceWithBase) = {
      play.api.libs.json.Json.obj(
        "currency" -> play.api.libs.json.JsString(obj.currency),
        "amount" -> play.api.libs.json.JsNumber(obj.amount),
        "label" -> play.api.libs.json.JsString(obj.label),
    ...
    def jsObjectZone(obj: io.flow.common.v0.models.Zone) = {
      play.api.libs.json.Json.obj(
