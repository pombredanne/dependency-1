 ...
 * apidoc:0.11.3 http://www.apidoc.me/flow/github/0.0.3/play_2_4_client
 */
package io.flow.github.v0.models {
  ...
  case class Hook(
    ...
    pingUrl: String,
    name: String,
    events: _root_.scala.Option[Seq[String]] = None,
    active: Boolean,
  ...
  package object json {
    ...
    implicit def jsonReadsGithubHook: play.api.libs.json.Reads[Hook] = {
      (
        ...
        (__ \ "name").read[String] and
        (__ \ "events").readNullable[Seq[String]] and
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.3 http://www.apidoc.me/flow/github/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
