 ...
 * apidoc:0.9.48 http://www.apidoc.me/bryzek/dependency/0.0.2-dev/play_2_4_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsDependencyLibrary: play.api.libs.json.Reads[Library] = {
      (
        ...
        (__ \ "resolver").read[com.bryzek.dependency.v0.models.ResolverSummary] and
        (__ \ "audit").read[io.flow.common.v0.models.Audit]
      )(Library.apply _)
    }
    ...
    implicit def jsonWritesDependencyLibrary: play.api.libs.json.Writes[Library] = {
      (
        ...
        (__ \ "resolver").write[com.bryzek.dependency.v0.models.ResolverSummary] and
        (__ \ "audit").write[io.flow.common.v0.models.Audit]
...
package com.bryzek.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.48 http://www.apidoc.me/bryzek/dependency/0.0.2-dev/play_2_4_client"
