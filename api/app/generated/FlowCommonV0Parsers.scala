 ...
 * apidoc:0.11.3 http://localhost:9000/flow/common/0.0.7/anorm_2_x_parsers
 */
import anorm._
...
package io.flow.common.v0.anorm.parsers {
  ...
  object Address {
    ...
    def parserWithPrefix(prefix: String) = parser(
      text = s"${prefix}_text",
      streets = s"${prefix}_streets",
      city = s"${prefix}_city",
      province = s"${prefix}_province",
      postalCode = s"${prefix}_postal_code",
      country = s"${prefix}_country"
    )
  ...
  object ExpandableOrganization {
    ...
    def parserWithPrefix(prefix: String) = {
      io.flow.common.v0.anorm.parsers.Organization.parserWithPrefix(prefix) |
      io.flow.common.v0.anorm.parsers.OrganizationReference.parserWithPrefix(prefix)
    }
  ...
  object ExpandableUser {
    ...
    def parserWithPrefix(prefix: String) = {
      io.flow.common.v0.anorm.parsers.User.parserWithPrefix(prefix) |
      io.flow.common.v0.anorm.parsers.UserReference.parserWithPrefix(prefix)
    }
